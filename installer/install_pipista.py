...
APP_FILES = (
    'Pipista.py',
    'pipista_core/__init__.py',
    'pipista_core/app_base.py',
    'pipista_core/frontend.py',
    'pipista_core/catalog.py',
    'pipista_core/dependencies.py',
    'pipista_core/environment.py',
    'pipista_core/github.py',
    'pipista_core/engine.py',
    'pipista_core/version.py',
    'pipista_core/pypi.py',
    'launchers/Pipista_Panel.py',
)
    ...
    with archive:
        for member in archive.infolist():
            ...
            if (
                ...
                raise RuntimeError(
                    'Repository archive contains an unsafe path: {}'.format(
                        relative
                    )
                )
